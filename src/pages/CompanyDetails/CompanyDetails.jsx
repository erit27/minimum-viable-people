        ...
        <div className="container-large">
          <div className="container-medium">
            <div className="company-details">
              <img
                src={logo}
                alt="Bench Company Logo"
                className="company-details__logo"
                onClick={navigateHome}
              />

              <h1 className="company-details__title">
                Tell us about your business
              </h1>
              <p className="company-details__description">
                We'd like to learn more about your business so that we can
                provide you with the best experience possible.
              </p>
              <h2 className="company-details__sub">COUNTRY</h2>
              <p className="company-details__sub-info">
                Select country your business is registered in
              </p>
              <form action="submit">
                <div>
                  <select
                    onChange={(e) => handleError(e)}
                    className={`company-details__selector ${
